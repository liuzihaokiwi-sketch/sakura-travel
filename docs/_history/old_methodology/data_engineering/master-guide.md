...
> 品类子文档: [../guides/restaurants.md](../guides/restaurants.md) / [hotels](../guides/hotels.md) / [spots](../guides/spots.md) / [shops](../guides/shops.md)
...
| 步骤 | 操作 | 关键规则 |
|------|------|---------|
| N1 | cuisine_type 归一化 | 所有原始值映射到标准菜系码（见 [../../SCHEMA.md](../../SCHEMA.md) 菜系枚举），维护 `cuisine_mapping.json` |
...
> 数据源完整目录（P0/P1/P2/P3 分级、访问方式、搜索词）见 [../sources/japan/](../sources/japan/) 各品类文件。
...
用OpenCLI替代。工具详情见 [../ops/tools-setup.md](../ops/tools-setup.md)。

---

## 十、data_confidence 标记

每条数据必须携带(详见 [../../SCHEMA.md](../../SCHEMA.md)):
...
详见: [../guides/spots.md](../guides/spots.md) 第四章
...
详见: [../guides/spots.md](../guides/spots.md) 第四b章
...
├── README.md
├── methodology/
│   ├── master-guide.md     本文档（方法论）
│   └── ../../SCHEMA.md      字段规范+可信度+校验规则
├── sources/                数据源目录（按地域+品类）
│   └── japan/
│       ├── restaurants.md / hotels.md / spots.md / shops.md / transport.md
├── guides/                 采集工作流
│   ├── restaurants.md / hotels.md / spots.md / shops.md
└── ops/
    ├── tools-setup.md
    ├── city-circle-template.md
    └── kansai-lessons.md
```
...
RULE-205: cuisine 必须在 ../../SCHEMA.md 菜系码枚举中
