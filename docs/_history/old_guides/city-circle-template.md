...
2. 按顺序填写每个章节
3. 完成调研后确认数量分配
4. 按 [guides/](../guides/) 各品类采集指南的流程执行采集
...
> 遵循 [methodology/master-guide.md](../methodology/master-guide.md) 第二b章"效率规则"
...
```
归一化步骤（详见 [methodology/master-guide.md](../methodology/master-guide.md) 3.1 节）:
...
> Phase 2 选品流程（Sonnet 批量结构化证据 + Opus 审关键条目）: 按 [methodology/master-guide.md](../methodology/master-guide.md) 第四b章和 [guides/](../guides/) 各品类指南执行
