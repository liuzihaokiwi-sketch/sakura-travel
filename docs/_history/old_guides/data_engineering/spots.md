...
> 数据源: [sources/japan/spots.md](../sources/japan/spots.md)
> 核心改动: 双 S 制（heritage_s / popular_s），JNTO/japan-guide 是主骨架
...
**完整数据源目录、分级、三轴分配、搜索词、访问方式**见 [sources/japan/spots.md](../sources/japan/spots.md)。

快速参考:
- quality 主骨架: japan-guide.com + JNTO
- execution: Google Maps（坐标/营业/热度）
- traveler_fit: 携程 + 小红书 + TripAdvisor
- 深度素材: 独立攻略站（Inside Kyoto / MATCHA 等）
...
样本量门槛(见 [methodology/master-guide.md](../methodology/master-guide.md) 第六章):
  >= 15: 取前10-20%
  6-14: 取best N + 编辑判断
  < 6: 仅收明确代表项，否则留空
