...
**防坑:**
- 合并脚本的 schema 必须包含所有来源的强信号字段（见 [methodology/master-guide.md](../methodology/master-guide.md) 3.1 节）
...
- 标准菜系码定义在 [SCHEMA.md](../../SCHEMA.md)，新城市圈先审菜系枚举，缺的先加
...
- 在 city-circle-template 的 Phase 1 批次表中写明每个 Agent 的输出路径
...
**防坑:**
- **必须执行 [methodology/master-guide.md](../methodology/master-guide.md) 3.1 节的 N1-N5 归一化步骤**
...
**防坑:**
- Agent 设 2 小时超时（city-circle-template 已写）
...
- [ ] 标准菜系码枚举已更新（新菜系先加到 [SCHEMA.md](../../SCHEMA.md)）
...
## 七、改进后的理想流程（对照 city-circle-template）
