...
CLUSTERS: list[dict] = [
    ...
    # ────────────────── 东京补充 ────────────────────────────────────────────
    {"cluster_id": "tok_kamakura_enoshima_day", "circle_id": "tokyo_metropolitan_circle", "city_code": "kamakura", "name_zh": "镰仓·江之岛日归线", "name_en": "Kamakura & Enoshima Day Trip", "level": "S", "default_duration": "full_day", "primary_corridor": "kamakura", "seasonality": ["all_year", "sakura", "summer"], "profile_fit": ["couple", "photo", "nature", "first_timer"], "trip_role": "anchor", "time_window_strength": "medium", "reservation_pressure": "none", "secondary_attach_capacity": 1, "default_selected": False, "notes": "镰仓大佛→长谷寺→江之电沿海→江之岛日落。从新宿JR约60分钟，灌篮高手圣地。"},
    {"cluster_id": "tok_nikko_world_heritage", "circle_id": "tokyo_metropolitan_circle", "city_code": "nikko", "name_zh": "日光·世界遗产日归线", "name_en": "Nikko World Heritage Day Trip", "level": "A", "default_duration": "full_day", "primary_corridor": "nikko", "seasonality": ["all_year", "autumn_leaves"], "profile_fit": ["culture", "history", "nature", "couple"], "trip_role": "anchor", "time_window_strength": "medium", "reservation_pressure": "none", "secondary_attach_capacity": 1, "default_selected": False, "notes": "东照宫（世界遗产）+华严瀑布+中禅寺湖。从浅草东武特急约2小时，秋季红叶绝美。"},
    {"cluster_id": "tok_disney_resort", "circle_id": "tokyo_metropolitan_circle", "city_code": "tokyo", "name_zh": "东京迪士尼度假区", "name_en": "Tokyo Disney Resort", "level": "S", "default_duration": "full_day", "primary_corridor": "maihama", "seasonality": ["all_year"], "profile_fit": ["family_child", "couple", "friends", "theme_park"], "trip_role": "anchor", "time_window_strength": "strong", "reservation_pressure": "high", "secondary_attach_capacity": 0, "default_selected": False, "notes": "迪士尼乐园/迪士尼海洋二选一，全天行程。需提前购票，周末/节假日极度拥挤。", "upgrade_triggers": {"tags": ["disney", "theme_park"], "party_types": ["family_child", "couple"]}},
    {"cluster_id": "tok_ginza_imperial_palace", "circle_id": "tokyo_metropolitan_circle", "city_code": "tokyo", "name_zh": "东京·银座皇居线", "name_en": "Tokyo Ginza & Imperial Palace", "level": "A", "default_duration": "half_day", "primary_corridor": "ginza", "seasonality": ["all_year", "sakura"], "profile_fit": ["shopping", "culture", "couple", "first_timer"], "trip_role": "enrichment", "time_window_strength": "weak", "reservation_pressure": "none", "secondary_attach_capacity": 2, "default_selected": False, "notes": "银座购物+皇居东御苑（免费）+二重桥。春季千鸟之渊樱花极美。"},
    {"cluster_id": "tok_kawaguchiko_fuji_view", "circle_id": "tokyo_metropolitan_circle", "city_code": "kawaguchiko", "name_zh": "河口湖·富士山眺望线", "name_en": "Kawaguchiko Mt. Fuji View", "level": "A", "default_duration": "full_day", "primary_corridor": "kawaguchiko", "seasonality": ["all_year", "autumn_leaves", "winter"], "profile_fit": ["couple", "photo", "nature"], "trip_role": "anchor", "time_window_strength": "medium", "reservation_pressure": "none", "secondary_attach_capacity": 1, "default_selected": False, "notes": "河口湖畔眺望富士山倒影+天上山缆车+浅间神社。从新宿巴士约2小时，冬季晴天最清晰。"},
    {"cluster_id": "tok_odaiba_teamlab", "circle_id": "tokyo_metropolitan_circle", "city_code": "tokyo", "name_zh": "东京·台场teamLab线", "name_en": "Tokyo Odaiba & teamLab", "level": "B", "default_duration": "half_day", "primary_corridor": "odaiba", "seasonality": ["all_year"], "profile_fit": ["couple", "friends", "photo", "family_child"], "trip_role": "buffer", "time_window_strength": "weak", "reservation_pressure": "medium", "secondary_attach_capacity": 1, "default_selected": False, "notes": "teamLab Borderless/Planets+自由女神像+DiverCity高达。适合下午到夜间。"},

    # ────────────────── 北海道补充 ──────────────────────────────────────────
    {"cluster_id": "hok_otaru_canal_glass", "circle_id": "hokkaido_nature_circle", "city_code": "otaru", "name_zh": "小樽·运河玻璃街半日线", "name_en": "Otaru Canal & Glass Street", "level": "A", "default_duration": "half_day", "primary_corridor": "otaru", "seasonality": ["all_year", "winter"], "profile_fit": ["couple", "photo", "shopping", "food"], "trip_role": "enrichment", "time_window_strength": "weak", "reservation_pressure": "none", "secondary_attach_capacity": 1, "default_selected": False, "notes": "小樽运河+堺町通北一硝子+LeTAO本店。从札幌JR约30分钟，冬季运河雪景+煤气灯最梦幻。"},
    {"cluster_id": "hok_shiretoko_nature", "circle_id": "hokkaido_nature_circle", "city_code": "abashiri", "name_zh": "知床·世界遗产自然线", "name_en": "Shiretoko World Heritage Nature", "level": "S", "default_duration": "full_day", "primary_corridor": "shiretoko", "seasonality": ["summer"], "profile_fit": ["nature", "adventure", "photo", "couple"], "trip_role": "anchor", "time_window_strength": "medium", "reservation_pressure": "medium", "secondary_attach_capacity": 0, "default_selected": False, "notes": "知床五湖+知床峠+カムイワッカ湯の滝。世界自然遗产，棕熊栖息地，5-10月开放。需向导同行。", "upgrade_triggers": {"tags": ["nature", "wildlife", "adventure"], "party_types": ["couple", "solo"]}},
    {"cluster_id": "hok_toya_noboribetsu_onsen", "circle_id": "hokkaido_nature_circle", "city_code": "toya", "name_zh": "洞爷湖·登别温泉线", "name_en": "Lake Toya & Noboribetsu Onsen", "level": "A", "default_duration": "full_day", "primary_corridor": "toya", "seasonality": ["all_year"], "profile_fit": ["couple", "senior", "onsen", "nature"], "trip_role": "anchor", "time_window_strength": "weak", "reservation_pressure": "low", "secondary_attach_capacity": 1, "default_selected": False, "notes": "洞爷湖火山口湖+登别地狱谷+第一滝本馆温泉。从札幌约2小时，推荐住一晚温泉旅馆。"},
    {"cluster_id": "hok_asahiyama_zoo", "circle_id": "hokkaido_nature_circle", "city_code": "asahikawa", "name_zh": "旭川·旭山动物园线", "name_en": "Asahikawa Asahiyama Zoo", "level": "A", "default_duration": "half_day", "primary_corridor": "asahikawa", "seasonality": ["all_year", "winter"], "profile_fit": ["family_child", "nature", "couple"], "trip_role": "enrichment", "time_window_strength": "medium", "reservation_pressure": "none", "secondary_attach_capacity": 1, "default_selected": False, "notes": "冬季企鹅散步是全球唯一的动物园体验。从札幌JR特急约1.5小时，可与富良野联动。"},
    {"cluster_id": "hok_drift_ice_abashiri", "circle_id": "hokkaido_nature_circle", "city_code": "abashiri", "name_zh": "网走·流冰破冰船体验", "name_en": "Abashiri Drift Ice Icebreaker", "level": "S", "default_duration": "half_day", "primary_corridor": "abashiri", "seasonality": ["winter"], "profile_fit": ["adventure", "nature", "photo", "couple"], "trip_role": "anchor", "time_window_strength": "strong", "reservation_pressure": "high", "secondary_attach_capacity": 1, "default_selected": False, "notes": "2月限定，破冰船切开鄂霍次克海流冰。需提前2-3周预约，世界稀缺体验。", "upgrade_triggers": {"tags": ["ice", "adventure", "nature"], "travel_months": [1, 2, 3]}},

    # ────────────────── 冲绳补充 ────────────────────────────────────────────
    {"cluster_id": "oki_shuri_castle_culture", "circle_id": "okinawa_island_circle", "city_code": "naha", "name_zh": "那霸·首里城琉球文化线", "name_en": "Shuri Castle & Ryukyu Culture", "level": "A", "default_duration": "half_day", "primary_corridor": "naha_shuri", "seasonality": ["all_year"], "profile_fit": ["culture", "history", "first_timer", "photo"], "trip_role": "enrichment", "time_window_strength": "medium", "reservation_pressure": "none", "secondary_attach_capacity": 1, "default_selected": False, "notes": "首里城（世界遗产，2026年修复中部分开放）+金城町石畳道+壶屋やちむん通。琉球王国历史核心。"},
    {"cluster_id": "oki_american_village", "circle_id": "okinawa_island_circle", "city_code": "naha", "name_zh": "冲绳中部·美国村购物线", "name_en": "American Village Shopping", "level": "B", "default_duration": "half_day", "primary_corridor": "chatan", "seasonality": ["all_year"], "profile_fit": ["shopping", "friends", "young", "photo"], "trip_role": "buffer", "time_window_strength": "weak", "reservation_pressure": "none", "secondary_attach_capacity": 1, "default_selected": False, "notes": "异国风情购物区+日落海滩+Depot Island。适合下午到傍晚，从那霸约40分钟车程。"},
    {"cluster_id": "oki_nago_pineapple_park", "circle_id": "okinawa_island_circle", "city_code": "naha", "name_zh": "冲绳北部·名护菠萝园+古宇利岛", "name_en": "Nago Pineapple Park & Kouri Island", "level": "B", "default_duration": "full_day", "primary_corridor": "nago", "seasonality": ["all_year"], "profile_fit": ["family_child", "couple", "nature"], "trip_role": "enrichment", "time_window_strength": "weak", "reservation_pressure": "none", "secondary_attach_capacity": 1, "default_selected": False, "notes": "名护菠萝园+古宇利大桥（最美跨海大桥）+古宇利海滩。可与水族馆同日安排。"},

    # ────────────────── 九州补充 ────────────────────────────────────────────
    {"cluster_id": "kyu_kumamoto_castle", "circle_id": "kyushu_onsen_circle", "city_code": "kumamoto", "name_zh": "熊本·熊本城加藤清正线", "name_en": "Kumamoto Castle & Kato Kiyomasa", "level": "A", "default_duration": "half_day", "primary_corridor": "kumamoto_city", "seasonality": ["all_year", "sakura"], "profile_fit": ["history", "culture", "photo", "first_timer"], "trip_role": "enrichment", "time_window_strength": "medium", "reservation_pressure": "none", "secondary_attach_capacity": 2, "default_selected": False, "notes": "日本三名城之一（2016地震后修复中，天守阁已开放）+水前寺成趣园+くまモンスクエア。从博多新干线40分钟。"},
    {"cluster_id": "kyu_kagoshima_sakurajima", "circle_id": "kyushu_onsen_circle", "city_code": "kagoshima", "name_zh": "鹿儿岛·樱岛火山线", "name_en": "Kagoshima Sakurajima Volcano", "level": "A", "default_duration": "full_day", "primary_corridor": "kagoshima", "seasonality": ["all_year"], "profile_fit": ["nature", "adventure", "photo", "couple"], "trip_role": "anchor", "time_window_strength": "medium", "reservation_pressure": "none", "secondary_attach_capacity": 1, "default_selected": False, "notes": "渡轮15分钟到活火山樱岛+有村熔岩展望所+天文馆通购物街。鹿儿岛黑猪涮涮锅必吃。"},

    # ────────────────── 中部补充 ────────────────────────────────────────────
    {"cluster_id": "chu_kamikochi_alpine", "circle_id": "chubu_mountain_circle", "city_code": "matsumoto", "name_zh": "上高地·日本阿尔卑斯徒步线", "name_en": "Kamikochi Alpine Hiking", "level": "S", "default_duration": "full_day", "primary_corridor": "kamikochi", "seasonality": ["summer", "autumn"], "profile_fit": ["nature", "hiking", "photo", "couple"], "trip_role": "anchor", "time_window_strength": "medium", "reservation_pressure": "low", "secondary_attach_capacity": 0, "default_selected": False, "notes": "河童桥+大正池+穂高岳登山口。4月下旬-11月中旬开放，禁止私家车进入（需换乘巴士）。日本最美山岳景观。", "upgrade_triggers": {"tags": ["hiking", "nature", "mountain"], "travel_months": [5, 6, 7, 8, 9, 10]}},
    {"cluster_id": "chu_nagoya_city", "circle_id": "chubu_mountain_circle", "city_code": "nagoya", "name_zh": "名古屋·城市半日线", "name_en": "Nagoya City Half Day", "level": "B", "default_duration": "half_day", "primary_corridor": "nagoya", "seasonality": ["all_year"], "profile_fit": ["food", "culture", "first_timer"], "trip_role": "buffer", "time_window_strength": "weak", "reservation_pressure": "none", "secondary_attach_capacity": 2, "default_selected": False, "notes": "名古屋城+大须商店街+热田神宫。到达/离开日可安排。味噌猪排/鳗鱼三吃/手羽先名古屋三大美食必吃。"},
]
