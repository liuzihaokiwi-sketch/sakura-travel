"""
seed_kansai_classic_circle_clusters.py — kansai_classic_circle 活动簇数据

从 mojor/ 目录转换生成。
幂等：cluster_id 已存在则 SKIP。

执行：
    python scripts/seed_kansai_clusters.py
"""
...
CLUSTERS = [
    {
        "cluster_id": "kyo_kurama_kibune_kawadoko",
        "city_code": "kyoto",
    ...
    {
        "cluster_id": "kyo_sagano_torokko_hozugawa",
        "city_code": "kyoto",
    ...
    {
        "cluster_id": "kyo_ohara_sanzenin_retreat",
        "city_code": "kyoto",
        "name_zh": "京都·大原三千院静修线",
    ...
    {
        "cluster_id": "kyo_takao_jingoji_autumn",
        "city_code": "kyoto",
        "name_zh": "京都·高雄神护寺红叶线",
    ...
    {
        "cluster_id": "kyo_machiya_kaiseki_luxury",
        "city_code": "kyoto",
    ...
    {
        "cluster_id": "kyo_kyoto_sakura_circuit",
        "city_code": "kyoto",
        "name_zh": "京都·樱花季城市总线",
    ...
    {
        "cluster_id": "kyo_kyoto_autumn_leaves_circuit",
        "city_code": "kyoto",
        "name_zh": "京都·红叶季城市总线",
    ...
    {
        "cluster_id": "kyo_gion_matsuri_festival",
        "city_code": "kyoto",
        "name_zh": "京都·祇园祭山鉾巡行线",
    ...
    {
        "cluster_id": "uji_byodoin_tea_heritage",
        "city_code": "uji",
        "name_zh": "宇治·平等院抹茶文化线",
    ...
    {
        "cluster_id": "osa_koyasan_shukubo_pilgrimage",
        "city_code": "osaka",
    ...
    {
        "cluster_id": "nara_yoshino_sakura_mountain",
        "city_code": "nara",
        "name_zh": "奈良·吉野山樱花线",
    ...
    {
        "cluster_id": "nara_yoshino_autumn_koyo",
        "city_code": "nara",
        "name_zh": "奈良·吉野山红叶展望线",
    ...
    {
        "cluster_id": "nara_horyuji_ikaruga_worldheritage",
        "city_code": "nara",
    ...
    {
        "cluster_id": "nara_todaiji_naramachi_core",
        "city_code": "nara",
        ...
        "reservation_pressure": "low",
        "secondary_attach_capacity": 2,
        "notes": "东大寺与奈良公园是奈良最强核心，但奈良町提供完全不同的旧城补充，因此\"东大寺/鹿/奈良町\"应作为独立核心线存在，而不只算",
        "experience_family": "shrine",
        "rhythm_role": "peak",
        "energy_level": "high"
    },
    {
        "cluster_id": "kobe_himeji_castle_kokoen_daytrip",
        "city_code": "kobe",
    ...
    {
        "cluster_id": "kobe_rokko_arima_nightview_escape",
        "city_code": "kobe",
    ...
    {
        "cluster_id": "kobe_nadagogo_sake_breweries",
        "city_code": "kobe",
        "name_zh": "神户·滩五乡酒藏巡游线",
    ...
    {
        "cluster_id": "kobe_nunobiki_ropeway_herbgarden",
        "city_code": "kobe",
        "name_zh": "神户·布引香草园索道线",
    ...
    {
        "cluster_id": "kobe_luminarie_winter",
        "city_code": "kobe",
    ...
    {
        "cluster_id": "arima_onsen_overnight_ryokan",
    ...
    {
        "cluster_id": "kyo_gion_pontocho_nightwalk",
        "city_code": "kyoto",
        "name_zh": "京都·祇园夜走先斗町线",
    ...
    {
        "cluster_id": "kyo_matcha_wagashi_crawl",
        "city_code": "kyoto",
        "name_zh": "京都·抹茶和果子甜品线",
    ...
    {
        "cluster_id": "kyo_miyako_odori_spring",
        "city_code": "kyoto",
        "name_zh": "京都·都踊春季歌舞线",
    ...
    {
        "cluster_id": "kyo_gozan_okuribi_night",
        "city_code": "kyoto",
        "name_zh": "京都·五山送火夜观线",
    ...
    {
        "cluster_id": "osa_umeda_stationcity_shopping",
        "city_code": "osaka",
        "name_zh": "大阪·梅田站城购物线",
    ...
    {
        "cluster_id": "osa_shinsaibashi_midosuji_shopping",
        "city_code": "osaka",
    ...
    {
        "cluster_id": "osa_osaka_nightview_observatories",
        "city_code": "osaka",
        "name_zh": "大阪·城市夜景展望台线",
    ...
    {
        "cluster_id": "osa_tenjin_matsuri_river_fireworks",
        "city_code": "osaka",
    ...
    {
        "cluster_id": "osa_midosuji_illumination_winter",
        "city_code": "osaka",
        "name_zh": "大阪·御堂筋灯饰冬季线",
    ...
    {
        "cluster_id": "kobe_bayarea_harbor_nightview",
        "city_code": "kobe",
        "name_zh": "神户·海港湾区夜景线",
...
async def seed():
    async with AsyncSessionLocal() as session:
        ...
        logger.info("=== %s 完成: 新增=%d 跳过=%d 总计=%d ===",
                     "kansai_classic_circle", new_count, skip_count, len(CLUSTERS))
