...
CLUSTERS = [
    ...
    # ── osaka_day_base_circle 专属簇（复制核心簇到第二圈）──────────────────
    {
        "cluster_id": "odc_usj_themepark",
        "circle_id": "osaka_day_base_circle",
        "name_zh": "大阪·USJ 环球影城",
        "name_en": "Osaka USJ (Day Base)",
        "level": "S",
        "default_duration": "full_day",
        "duration_range_days": "1.0-1.0",
        "primary_corridor": "sakurajima",
        "seasonality": ["all_year"],
        "profile_fit": ["family_child", "friends", "theme_park", "solo"],
        "trip_role": "anchor",
        "can_drive_hotel": False,
        "time_window_strength": "strong",
        "reservation_pressure": "high",
        "secondary_attach_capacity": 0,
        "default_selected": False,
        "notes": "大阪基点圈 USJ。全天行程，从难波出发 30 分钟。",
        "upgrade_triggers": {"tags": ["theme_park", "food"], "party_types": ["friends", "solo"]},
    },
    {
        "cluster_id": "odc_dotonbori_food",
        "circle_id": "osaka_day_base_circle",
        "name_zh": "大阪·道顿堀美食",
        "name_en": "Osaka Dotonbori Food (Day Base)",
        "level": "S",
        "default_duration": "half_day",
        "duration_range_days": "0.3-0.5",
        "primary_corridor": "namba",
        "seasonality": ["all_year"],
        "profile_fit": ["food", "couple", "friends", "first_timer", "solo"],
        "trip_role": "anchor",
        "can_drive_hotel": True,
        "time_window_strength": "weak",
        "reservation_pressure": "medium",
        "secondary_attach_capacity": 2,
        "default_selected": True,
        "notes": "大阪基点圈美食主线。章鱼烧→大阪烧→串炸。",
    },
    {
        "cluster_id": "odc_osakajo",
        "circle_id": "osaka_day_base_circle",
        "name_zh": "大阪·大阪城天满桥",
        "name_en": "Osaka Castle (Day Base)",
        "level": "A",
        "default_duration": "half_day",
        "duration_range_days": "0.4-0.5",
        "primary_corridor": "osakajo",
        ...
        "secondary_attach_capacity": 1,
        "default_selected": False,
        "notes": "大阪城天守阁，大阪基点圈标配。",
    },
    {
        "cluster_id": "odc_fushimi_daytrip",
        "circle_id": "osaka_day_base_circle",
        "name_zh": "京都·伏见稻荷（大阪日归）",
        "name_en": "Fushimi Inari Day Trip from Osaka",
        "level": "A",
        "default_duration": "half_day",
        "duration_range_days": "0.5-0.7",
        "primary_corridor": "fushimi",
        "seasonality": ["all_year"],
        "profile_fit": ["first_timer", "photo", "couple", "solo", "culture"],
        "trip_role": "anchor",
        "can_drive_hotel": False,
        "time_window_strength": "strong",
        "reservation_pressure": "none",
        "secondary_attach_capacity": 1,
        "default_selected": False,
        "notes": "从大阪难波出发约 50 分钟直达伏见稻荷。千本鸟居必打卡。",
        "upgrade_triggers": {"tags": ["photo", "culture"], "party_types": ["solo", "couple"]},
    },
    {
        "cluster_id": "odc_shinsekai",
        "circle_id": "osaka_day_base_circle",
        "name_zh": "大阪·新世界天王寺",
        "name_en": "Osaka Shinsekai (Day Base)",
        "level": "B",
        "default_duration": "quarter_day",
        "duration_range_days": "0.25-0.4",
        "primary_corridor": "shinsekai",
...
HOTEL_PRESETS = [
    ...
    # ── 大阪单基点圈（第二圈）──────────────────────────────────────────────
    {
        ...
        "bases": [
            {
                ...
                "served_cluster_ids": [
                    ...
                    "osa_osaka_castle_tenmabashi",
                    "osa_shinsekai_tenno",
                    "kyo_fushimi_inari",            # 京都日归：伏见稻荷
                    "kyo_higashiyama_gion_classic",  # 京都日归：东山祇园
                ],
            }
        ],
        ...
        "last_night_airport_minutes": 30,
        "priority": 10,
        "notes": "大阪为基点短途圈。适合天数少（3-5天）或以购物/美食为主的旅行者。京都/USJ均可当日往返。",
        "is_active": True,
    },
]
