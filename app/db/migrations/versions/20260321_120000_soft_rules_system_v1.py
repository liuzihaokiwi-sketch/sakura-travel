"""soft_rules_system_v1 — 创建软规则系统相关表

Revision ID: soft_rules_system_v1
...
revision: str = "soft_rules_system_v1"
...
def upgrade() -> None:
    ...
    op.create_table('preview_trigger_scores',
        ...
        sa.Column('calculated_at', sa.DateTime(timezone=True), nullable=False, server_default=sa.text('now()')),
        sa.ForeignKeyConstraint(['day_id'], ['itinerary_days.day_id'], ondelete='CASCADE'),
        sa.Index('ix_preview_trigger_scores_day_id', 'day_id'),
    )
